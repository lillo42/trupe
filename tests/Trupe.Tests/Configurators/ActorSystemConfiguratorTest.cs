...
//             .That(services)
//             .Contains(x =>
//                 x.ServiceType == typeof(IActorProcessRegistry)
...
//     [Test]
//     [SkipOnNativeAot]
//     public async Task SetActorRegistery_Should_RegisterCustomActorRegistery()
//     {
//         // Arrange
//         var services = new ServiceCollection();
//         var configurator = new ActorSystemConfigurator(services);
//         var customRegister = NSubstitute.Substitute.For<IActorProcessRegistry>();
//
//         // Act
//         configurator.SetActorRegistery(customRegister);
//
//         // Assert
//         var provider = services.BuildServiceProvider();
//         var resolved = provider.GetRequiredService<IActorProcessRegistry>();
//         await Assert.That(resolved).IsSameReferenceAs(customRegister);
//     }
//
//     [Test]
//     [SkipOnNativeAot]
//     public async Task SetActorRegistery_Should_ReturnSameConfigurator()
//     {
//         // Arrange
//         var services = new ServiceCollection();
//         var configurator = new ActorSystemConfigurator(services);
...
//
//         // Act
//         var result = configurator.SetActorRegistery(customRegister);
//
//         // Assert
//         await Assert.That(result).IsSameReferenceAs(configurator);
//     }
